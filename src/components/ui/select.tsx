...
export function Select({ className, children, ...props }: SelectProps) {
  return (
    <select
      className={cn(
        "h-10 w-full min-w-0 appearance-none rounded-lg border border-zinc-200 bg-white px-3 pr-9 text-sm outline-none ring-zinc-900/10 transition-colors focus:border-zinc-400 focus:ring-2 dark:border-zinc-700 dark:bg-zinc-950 dark:ring-zinc-100/10 dark:focus:border-zinc-500",
